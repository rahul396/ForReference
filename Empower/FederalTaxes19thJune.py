...
class Federal_Tax(object):
    ...
    def calculate_federal_tax(self,single_or_joint,taxable_income_pre_deduction, simulation_year_number =-1):
        ...
        taxable_income = taxable_income_pre_deduction - self.standard_deduction_single
        if self.convert_single_or_joint(single_or_joint) =="single":   #Rahul: this function doesn't return string.. not valid here
...
print(a.calculate_federal_tax("single",200000,0))