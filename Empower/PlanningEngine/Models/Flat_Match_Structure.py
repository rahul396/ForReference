...
class Flat_Match_Structure(object):
    ...
    def adjust_match_for_salary_and_limit(self):
        sorted_fms = self.sort_by_column(
            ['owner_name', 'job_name', 'account_type', 'match_amount'], False)
        ...
        for row_iter in range(num_rows):
            ...
            while temp_id == sorted_fms.loc[row_iter, "owner_name"] + sorted_fms.loc[row_iter, "job_name"] + \
                ...
                if limit_reached:
                    ...
                    sorted_fms.set_value(
                        row_iter, "match_limit", salary_or_plan_limit - running_total)
                    limit_reached = True
