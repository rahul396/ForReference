import numpy as np
import Models.Contribution as contr


class Sim_Contribution_Flat(object):
    def __init__(self, earnings_array, years_to_retirement, owner_name, each_account, contri_obj, smart_obj='',
                 match_obj=''):
        ...
        self.account_id = each_account.name
