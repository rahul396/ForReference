...
class Sim_Account_Flat(object):
    def __init__(self, account_id, money_type, start_balance, sim_file, penality_age,
                 penality_amount,
                 account_rmd_applies, default_cashflow_status, owner_age,
                 locked_for_withdrawal_period=-1):
        self.id = account_id
    ...
    def print_properties(self):
        print(self.id, " ", self.money_type, " ", self.penality_age, " ",
              self.locked_for_withdrawal_period, " "
