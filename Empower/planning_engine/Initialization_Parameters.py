import Account_Type_Initalization as ati
import Asset_Class_Properties as acp
import Mortality as mort
import Account as act
import Social_Security as ss
import Error_Obj as e
import Earnings_Curves as ec
import Account_Contribution_Limit_Initalization as acli
import RMD as rmd
import os
...
class Initialization_Parameters(object):
    ...
    def __init__(self,  file_path):
        ...
        self.account_contribution_limit_init = acli.Account_Contribution_Limit_Initalization(file_path, 3, self.error_init)
